    ...
    >
      <div style={{ marginBottom: 24, textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--color-text-muted)', marginTop: 6 }}>
          Start keeping your endpoints alive in minutes
        </p>
      </div>
      ...
      {isConfigured ? (
        ...
        >
          ...
          <p style={{ fontSize: 14, color: 'var(--color-text-muted)', marginBottom: 20, lineHeight: 1.6 }}>
            To enable live registration and workspace creation, Pyra requires real Clerk API keys. Set them in your local environment:
          </p>
